...
<div class="content-wrapper">
        ...
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Create Broadcast</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
    ...
    <section class="content white-bg">
        <form id="addForm" class="form-head" method="POST" novalidate autocomplete="false" action="{{route('common.training.sport.add')}}">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Title" name="title" value="<?php echo !empty($result['title']) ? $result['title'] : ''; ?>">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <textarea class="form-control text-editor" placeholder="Message" name="message"><?php echo !empty($result['message']) ? $result['message'] : ''; ?></textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group custom-form-check-head">
                            <div class="custom-form-check">
                                <label class="form-check">
                                    <input type="checkbox" value="1" name="signed_up_last_thirty_days" {{!empty($result) && $result->signed_up_last_thirty_days==1 ? "checked" : ""}}> <span>Signed up(in last 30 days)</span>
                                    <div class="checkbox__checkmark"></div>
                                </label>
                            </div>
                            ...
                            <div class="custom-form-check pt-1">
                                <label class="form-check">
                                    <input type="checkbox" id="lastLoginBetween" value="1" name="last_login_between" {{!empty($result) && $result->last_login_between==1 ? "checked" : ""}}> <span>Last Login Between</span>
                                    <div class="checkbox__checkmark"></div>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6" id="dateRangePickerDivId" {{!empty($result) && $result->last_login_between==0 ? "style=display:none" : ""}}>
                            <div class="form-group">
            ...
            <div class="row">
                <div class="form-group custom-radio">
                    <label class="form-check ">
                        <input type="radio" class="schedule-time" value="now" name="type" checked> <span>Now</span>
                    </label>
                    <label class="form-check ">
                        <input type="radio" class="schedule-time" value="scheduled" name="type"> <span>Scheduled</span>
                    </label>
                </div>
            </div>
            <div class="row" id="scheduledTimeDivId" style="display:none">
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" id="scheduleDate" class="form-control" placeholder="Scheduled Date" name="scheduled_date">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" id="timepicker" class="form-control" placeholder="Scheduled Time" name="scheduled_time">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" readonly="true" value="{{$timezone}}" class="form-control" placeholder="Timezone" name="timezone">
                    </div>
                </div>
            </div>
            <div class="btn_row text-center">
                <button type="button" class="btn btn-secondary ripple-effect-dark btn-120" id="addBtn" onClick="saveBroadcast()">Add<span id="addBtnLoader" class="spinner-border spinner-border-sm" style="display: none;"></span></button>
...
@section('js')
{{-- {!! JsValidator::formRequest('App\Http\Requests\BroadcastRequest','#addForm') !!} --}}
...
<script>
    ...
    function saveBroadcast() {
        ...
        if ($('#addForm').valid()) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('common.saveBroadcast')}}",
                data: formData,
                ...
                error: function(err) {
                    ...
                    if (err.status === 422) {
                        ...
                        _toast.error('Broadcast not created.');
                    }
                },
            });
        }
    ...
    $(function() {
        $("#scheduleDate").datepicker();//moment().format('MM/DD/YYYY')
        ...
        $(".schedule-time").on('click', function() {
            ...
            if (this.value == "scheduled") {
                ...
                $("#scheduleDate").datepicker('setDate', moment().format('MM/DD/YYYY'));
            }
        });
