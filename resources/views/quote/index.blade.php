        ...
        <div class="page-title-row d-sm-flex align-items-center justify-content-between">
            ...
            @if ($userType == 'admin')
                <div class="right-side mt-2 mt-md-0">
                    <a href="{{ route('user.addQuoteForm', ['user_type' => $userType]) }}"
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th><span class="sorting">Author</span></th>
...
@section('js')
    <script>
         ...
         * @response object.
         */
        function loadQuoteList(url) {
            $("#listId").html('{{ ajaxTableListLoader() }}');
            url = url || "{{ route('common.loadQuoteList') }}";
        ...
        function changeStatus(id, status) {
            ...
            bootbox.confirm('Are you sure you want to ' + statusType + ' this quote ?', function(result) {
                if (result) {
                    var url = "{{ route('common.changeQuoteStatus', ['id' => '%recordId%']) }}";
