            ...
            <tr>
                <td style="padding-top:5px;padding-bottom:5px;">
                   <div style="font-size:15px;color:#000;font-family:Tahoma, Geneva, sans-serif;padding-left: 25px;margin-top:0;margin-bottom:5px;">
                        <p>{{$data['athlete_name']}} has requested to make their athlete account connected to you as a parent. Please review and accept the request at your earliest convenience.</p>
                   </div> 
                </td>
            </tr>
            <tr>
                <td style="padding-top:5px;padding-bottom:5px;">
                   <div style="font-size:15px;color:#000;font-family:Tahoma, Geneva, sans-serif;padding-left: 25px;margin-top:0;margin-bottom:5px;">
                    <a href="{{ $data['link'] }}" target="_blank">Click Here to Accept</a>
                   </div> 
                </td> 
            </tr>
