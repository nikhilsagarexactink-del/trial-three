        ...
        <table align="center"  style="border-collapse:collapse;padding:50px; font-family:Tahoma, Geneva, sans-serif;background-color:#ffffff;font-size:16px;border:1px solid #dee2e6;width:800px;" >
            ...
            <tr>
                <td style="padding-top:5px;padding-bottom:5px;">
                    <p style="font-size:15px;color:#000;font-family:Tahoma, Geneva, sans-serif;padding-left: 25px;margin-top:0;margin-bottom:5px;">Click this link to reset the password <a href="{{ $data['link'] }}">Click Here</p>
                </td>
            </tr>
            ...
            <tbody>
                <tr>
                    <td style="padding-top:10px;padding-bottom:10px;background-color:#2D3342;">
                        <p style="font-size:14px;color:#fff;font-family:Tahoma, Geneva, sans-serif;text-align:center; margin: 0;">© {{date('Y')}} Turbo Charged Athletics.</p>
                    </td>
                </tr>
            </tbody>
        </table>
