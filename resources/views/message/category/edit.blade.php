        ...
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('user.messageCategory', ['user_type'=>$userType])}}">Message Categories</a></li>
    ...
    <section class="content white-bg">
        <form id="updateForm" class="form-head" method="POST" novalidate autocomplete="false" action="{{route('common.updateCategory',['id'=>$id])}}">
            ...
            <div class="btn_row text-center">
                ...
                <a class="btn btn-outline-dark ripple-effect-dark btn-120 ml-2" href="{{route('user.messageCategory', ['user_type'=>$userType])}}">Cancel</a>
            </div>
        </form>
    </section>
</div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if(response.success){
                        ...
                        setTimeout(function(){
                            window.location.href = "{{route('user.messageCategory', ['user_type'=>$userType])}}";
                        },500)
                    }else{
