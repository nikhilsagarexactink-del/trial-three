...
<div class="content-wrapper">
    <div class="page-title-row d-sm-flex align-items-center justify-content-between">
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Message Categories</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
        ...
        <div class="right-side mt-2 mt-md-0">
            <a href="{{route('user.addMessageCategoryForm', ['user_type'=>$userType])}}" class="btn btn-secondary ripple-effect-dark text-white">
                Add
            </a>
        </div>
    </div>
...
<script>
    ...
    function loadList(url) {
        ...
        url = url || "{{route('common.loadMessageCategoryList')}}";
