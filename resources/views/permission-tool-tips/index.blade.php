@extends('layouts.app')
<title>Permissions Module Tool Tips Text</title>
@section('content')
        ...
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> Permissions Module Tool Tips Text</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
            <h2 class="page-title text-capitalize mb-0">
                Permissions Module Tool Tips Text
            </h2>
            <!-- Page Title End -->
        </div>
        @if($userData->user_type == 'admin')
        <div class="right-side mt-2 mt-md-0">
            <a href="{{route('user.addPermissinToolTipForm', ['user_type'=>$userType])}}"
        ...
        <div class="flex-row justify-content-between align-items-end">
            <div class="left">
                ...
                <form action="javascript:void(0)" id="searchFilterForm">
                    <input type="hidden" name="sort_by" id="sortByFieldId" value="permission_tool_tips.created_at">
        ...
        <div class="mCustomScrollbar" data-mcs-axis='x'>
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>S.No.</th>
                        <th><span class="sorting">Module Name</span></th>
                        <th><span class="sorting">Tool Tip Text</span></th>
...
<script>
var orderBy = {
    field: 'permission_tool_tips.created_at',
    order: 'DESC',
};
...
function loadList(url) {
    ...
    url = url || "{{route('common.loadPermissionToolTipList')}}";
...
function changeStatus(id, status) {
    ...
    bootbox.confirm('Are you sure you want to ' + statusType + ' this Permission tool tip ?', function(result) {
        if (result) {
            var url = "{{route('common.changePermissionToolTipStatus', ['id'=>'%recordId%'])}}";
