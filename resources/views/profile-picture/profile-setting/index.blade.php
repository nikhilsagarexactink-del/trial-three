...
<div class="content-wrapper">
    <main class="main-content add-page setting-page">
        ...
        <div class="form-box box-shadow">
            <div class="card">
                <div class="card-body">
                    <form id="updateProfileForm" method="POST" novalidate autocomplete="false" action="{{route('common.profileSetting.update')}}">
                        @csrf
                        <input type="hidden" value="{{!empty($profileDetail) ? $profileDetail->id : ''}}" name="id">
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <div class="upload_photo mx-auto text-center col-12">
                                        <div class="img-box">
                                            <div class="profile-img">
                                                ...
                                                <img src="{{$profileDetail->media->base_url}}" id="imagePreview" alt="user-img" class="img-fluid rounded-circle">
                                                @else
                                                <img src="{{ asset('assets/images/default-user.jpg') }}" id="imagePreview" alt="user-img" class="img-fluid rounded-circle">
                                                @endif
                                            </div>
                                            ...
                                            <label class="mb-0 edit-icon">
                                                ...
                                                <a href="javascript:void(0)" onClick="showImageModal()"><i class="fas fa-pencil-alt"></i></a>
                                                <input type="hidden" id="hiddenMediaFileId" value="{{!empty($profileDetail) ? $profileDetail->media_id : ''}}" name="media_id">
                                            </label>
                                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="First Name" value="{{!empty($profileDetail) ? $profileDetail->first_name : ''}}" name="first_name">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Last Name<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Last Name" value="{{!empty($profileDetail) ? $profileDetail->last_name : ''}}" name="last_name">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Screen Name<span class="text-danger"></span></label>
                                    <input type="text" class="form-control" placeholder="Screen Name" value="{{!empty($profileDetail) ? $profileDetail->screen_name : ''}}" name="screen_name">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Email<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" disabled readonly="true" placeholder="Enter Email" value="{{!empty($profileDetail) ? $profileDetail->email : ''}}" name="email">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Cell Phone" value="{{!empty($profileDetail) ? $profileDetail->cell_phone_number : ''}}" name="cell_phone_number">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Address</label>
                                    <input type="text" id="autocomplete" class="form-control" placeholder="Address" name="address" value="{{!empty($profileDetail) ? $profileDetail->address : ''}}">
                                    <input type="hidden" id="countryNameFieldId" name="country" value="{{!empty($profileDetail) ? $profileDetail->country : ''}}">
                                    <input type="hidden" id="stateFieldId" name="state" value="{{!empty($profileDetail) ? $profileDetail->state : ''}}">
                                    <input type="hidden" id="cityFieldId" name="city" value="{{!empty($profileDetail) ? $profileDetail->city : ''}}">
                                    <input type="hidden" id="zipCodeFieldId" name="city" value="{{!empty($profileDetail) ? $profileDetail->zip_code : ''}}">
                                    <input type="hidden" id="latitudeFieldId" name="latitude" value="{{!empty($profileDetail) ? $profileDetail->latitude : ''}}">
                                    <input type="hidden" id="longitudeFieldId" name="longitude" value="{{!empty($profileDetail) ? $profileDetail->longitude : ''}}">
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="age">
                                        ...
                                        @for( $i=1; $i<=99; $i++ ) <option value="{{$i}}" {{(!empty($profileDetail) && $profileDetail->age==$i) ? 'selected' : ''}}>{{$i}}</option>
                                            @endfor
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="gender">
                                        ...
                                        <option value="male" {{(!empty($profileDetail) && $profileDetail->gender=='male')  ? 'selected' : ''}}>Male</option>
                                        <option value="female" {{(!empty($profileDetail) && $profileDetail->gender=='female')  ? 'selected' : ''}}>Female</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group multi-select">
                                    <label for="">Favorite Sport(s)</label>
                                    <select class="js-example-basic-multiple form-control" id="sportAutocomplte" name="favorite_sport[]" multiple="multiple">
                            ...
                            <div class="col-sm-6" id="favorite_sport_play_years" style="{{empty($selectedSports) ? 'display:none' : ''}}">
                                <div class="form-group">
                                    <label for="">How many years have you played?</label>
                                    <input type="text" class="form-control" id="favorite_sport_play_years" placeholder="How many years have you played?" name="favorite_sport_play_years" value="{{!empty($profileDetail) ? $profileDetail->favorite_sport_play_years : ''}}">
                                    <span id="favorite_sport_play_years-error" class="help-block error-help-block" style="color:#dc3545!important"></span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">School Name</label>
                                    <input type="text" class="form-control" placeholder="School Name" name="school_name" value="{{!empty($profileDetail) ? $profileDetail->school_name : ''}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="grade">
                                        ...
                                        <option value="1" {{(!empty($profileDetail) && $profileDetail->grade==1)  ? 'selected' : ''}}>1</option>
                                        <option value="2" {{(!empty($profileDetail) && $profileDetail->grade==2)  ? 'selected' : ''}}>2</option>
                                        <option value="3" {{(!empty($profileDetail) && $profileDetail->grade==3)  ? 'selected' : ''}}>3</option>
                                        <option value="4" {{(!empty($profileDetail) && $profileDetail->grade==4)  ? 'selected' : ''}}>4</option>
                                        <option value="5" {{(!empty($profileDetail) && $profileDetail->grade==5)  ? 'selected' : ''}}>5</option>
                                        <option value="6" {{(!empty($profileDetail) && $profileDetail->grade==6)  ? 'selected' : ''}}>6</option>
                                        <option value="7" {{(!empty($profileDetail) && $profileDetail->grade==7)  ? 'selected' : ''}}>7</option>
                                        <option value="8" {{(!empty($profileDetail) && $profileDetail->grade==8)  ? 'selected' : ''}}>8</option>
                                        <option value="9" {{(!empty($profileDetail) && $profileDetail->grade==9)  ? 'selected' : ''}}>9</option>
                                        <option value="10" {{(!empty($profileDetail) && $profileDetail->grade==10)  ? 'selected' : ''}}>10</option>
                                        <option value="11" {{(!empty($profileDetail) && $profileDetail->grade==11)  ? 'selected' : ''}}>11</option>
                                        <option value="12" {{(!empty($profileDetail) && $profileDetail->grade==12)  ? 'selected' : ''}}>12</option>
                                        <option value="college" {{(!empty($profileDetail) && $profileDetail->grade=='college')  ? 'selected' : ''}}>College</option>
                                        <option value="other" {{(!empty($profileDetail) && $profileDetail->grade=='other')  ? 'selected' : ''}}>Other</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="countryAutoComplete" class="form-control" placeholder="Country" name="country" value="{{!empty($profileDetail) ? $profileDetail->country : ''}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">State<span class="text-danger">*</span></label>
                                    <input type="text" id="stateAutoComplete" class="form-control" placeholder="State" name="state" value="{{!empty($profileDetail) ? $profileDetail->state : ''}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">City<span class="text-danger">*</span></label>
                                    <input type="text" id="cityAutoComplete" class="form-control" placeholder="City" name="city" value="{{!empty($profileDetail) ? $profileDetail->city : ''}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Zip Code<span class="text-danger">*</span></label>
                                    <input type="text" id="zipcodeAutoComplete" class="form-control" placeholder="Zip Code" name="zip_code" value="{{!empty($profileDetail) ? $profileDetail->zip_code : ''}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Favorite Athlete</label>
                                    <input type="text" id="atheleteAutocomplte" class="form-control" placeholder="Favorite Athlete" name="favorite_athlete" value="{{!empty($profileDetail) ? $profileDetail->favorite_athlete : ''}}">
                                </div>
                            </div>
                            @endif
                            <div class="col-sm-12 text-center btn_row">
                                <button onClick="updateProfile()" id="updateProfiledBtn" class="mb-4 btn btn-primary min-width ripple-effect">Update<span id="updateProfiledBtnLoader" class="spinner-border spinner-border-sm" style="display: none;"></span></button>
                            </div>
                        </div>
                    </form>
                    <form id="changePasswordForm" method="POST" novalidate autocomplete="false" action="{{route('common.changePassword')}}">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="text-center btn_row submit-btn">
                            <button type="button" onClick="changePassword()" id="changePasswordBtn" class="btn btn-primary min-width ripple-effect">Update<span id="changePasswordBtnLoader" class="spinner-border spinner-border-sm" style="display: none;"></span></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="defaultProfileImages" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <span class="border border-light image-box" onClick="selectDefaultImage({{$image}})">
                                <img class="d-img" id="imageBox{{$image->id}}" src="{{$image->media->base_url}}" height="100px" width="100px">
                            </span>
                        </div>
                        @endforeach
                        @else
                    ...
                    <div class="row">
                        ...
                        <div class="right-side mt-2 mt-md-0 image-upload">
                            ...
                            <input type="file" id="UploadImg" onchange="setImage(this)" class="btn btn-secondary ripple-effect-dark text-white upload-image-field" name="profile_img">
                            <a href="javascript:void(0)" class="btn btn-secondary"><img class="" src="{{ url('assets/images/file-upload.svg') }}">File upload </a>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick="closeImageModal()">Close</button>
...
<script>
    ...
    $(function() {
        ...
        $('#sportAutocomplte').on("select2:unselect", function(e) {
            let selectedVal = $('#sportAutocomplte').val();
            if (!selectedVal.length) {
                $('#favorite_sport_play_years').hise();
