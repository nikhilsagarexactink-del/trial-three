        ...
        <div class="page-title-row d-sm-flex align-items-center justify-content-between">
            <div class="left-side">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Difficulty</li>
                    </ol>
                </nav>
                <!-- Breadcrumb End -->
                <!-- Page Title Start -->
            ...
            @if ($userType == 'admin')
                <div class="right-side mt-2 mt-md-0">
                    <a href="{{ route('user.addFormDifficulty', ['user_type' => $userType]) }}"
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            {{-- <th><span class="sorting" >Visibility</span></th> --}}
...
@section('js')
    <script>
        ...
        function loadList(url) {
            ...
            url = url || "{{ route('common.loadDifficultyList') }}";
        ...
        function changeStatus(id, status) {
            ...
            bootbox.confirm('Are you sure you want to ' + statusType + ' this plan ?', function(result) {
                if (result) {
                    var url = "{{ route('common.changeDifficultyStatus', ['id' => '%recordId%']) }}";
