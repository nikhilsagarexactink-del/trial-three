@extends('layouts.app')
<title>Custom Workout Names</title>
@section('content')
            ...
            <div class="left-side">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Custom Workout Names</li>
                    </ol>
                </nav>
                <!-- Breadcrumb End -->
                <!-- Page Title Start -->
                ...
                <div class="right-side mt-2 mt-md-0">
                    <a href="{{ route('user.addCustomWorkoutNameForm', ['user_type' => $userType]) }}"
...
@section('js')
    <script>
        ...
        function loadList(url) {
            ...
            url = url || "{{ route('common.loadListCustomWorkoutName') }}";
        ...
        function changeStatus(id, status) {
            ...
            bootbox.confirm('Are you sure you want to ' + statusType + ' this Workout Name ?', function(result) {
                if (result) {
                    var url = "{{ route('common.changeCustomWorkoutNameStatus', ['id' => '%recordId%']) }}";
