        ...
        <div class="page-title-row d-sm-flex align-items-center justify-content-between">
            <div class="left-side">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Workout Categories</li>
                    </ol>
                </nav>
                <!-- Breadcrumb End -->
                <!-- Page Title Start -->
            ...
            @if ($userType == 'admin')
                <div class="right-side mt-2 mt-md-0">
                    <a href="{{ route('user.addWorkoutCategory', ['user_type' => $userType]) }}"
            ...
            <div class="flex-row justify-content-between align-items-end">
                <div class="left">
                    ...
                    <form action="javascript:void(0)" id="searchFilterForm">
                        ...
                        <input type="hidden" name="type" value="workout-builder">
            ...
            <div class="mCustomScrollbar" data-mcs-axis='x'>
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th>S.No.</th>
                            <th><span class="sorting" sort-by="name">Name</span></th>
...
@section('js')
    <script>
        ...
        function loadList(url) {
            ...
            url = url || "{{ route('common.loadWorkOutCategoryList') }}";
        ...
        function changeStatus(id, status) {
            ...
            bootbox.confirm('Are you sure you want to ' + statusType + ' this category ?', function(result) {
                if (result) {
                    var url = "{{ route('common.changeCategoryStatus', ['id' => '%recordId%']) }}";
