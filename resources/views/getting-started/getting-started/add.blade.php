@extends('layouts.app')
@section('head')
<title>Getting Started | Add</title>
@endsection
        ...
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('user.manageGettingStarted.index', ['user_type'=>$userType])}}">Getting Started</a></li>
                    <li class="breadcrumb-item active">Create Getting Started</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
...
<!-- {!! JsValidator::formRequest('App\Http\Requests\GettingStartedRequest','#addForm') !!} -->
