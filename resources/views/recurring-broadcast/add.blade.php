...
<div class="content-wrapper">
        ...
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Create Recurring Broadcast</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
    ...
    <section class="content white-bg recurring-broadcast-sec">
        <form id="addForm" class="form-head" method="POST" novalidate autocomplete="false" action="{{route('common.saveRecurringBroadcast')}}">
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="row">
                                ...
                                <label for="trigger_type">Event Trigger</label>
                                    <div class="select-arrow">
                                        <select  class="selectpicker select-custom form-control" id="trigger_type" name="trigger_event" onchange="showFieldsBasedOnTrigger()">
                                            ...
                                            <option value="day_after_sign_up">Day After Sign Up</option>
                                            <option value="last_login">Last Login</option>
                                            <option value="hasnt_logged_in">Hasn’t Logged In</option>
                                            <option value="anniversary">Anniversary</option>
                                        </select>
                                    </div>
                            </div>
                        </div>
                        <div id="userSignupFields" class="trigger-fields col-md-12" style="display: none;">
                                   <div class="row">
                                            <div  class="col-md-6">
                                                <div class="form-group ">
                                                <label for="from_day">From Day</label>
                                                <input type="number" id="from_day" name="from_day" class="form-control" placeholder="-7" max="0">
                                                <span id="from_day-error" class="help-block error-help-block text-danger"></span>
                                                </div>
                                            </div>
                                        <div class=" col-md-6">
                                            <div class="form-group">
                                            <label for="to_day">To Day</label>
                                            <input type="number" id="to_day" name="to_day" class="form-control" placeholder="0"  min="-1000" max="0">
                                            <span id="to_day-error" class="help-block error-help-block text-danger"></span>
                                            </div>
                                        </div>
                                   </div>
                            </div>  
                            <div id="hasntLoggedInFields" class=" trigger-fields col-md-12" style="display: none;">
                        <div class="form-group">
                        ...
                        <div id="anniversaryFields" class=" trigger-fields col-md-12" style="display: none;">
                          <div class="form-group">
...
@section('js')
{{-- {!! JsValidator::formRequest('App\Http\Requests\RecurringBroadcastRequest','#addForm') !!} --}}
...
<script>
    tinymce.init({
        ...
        convert_urls: false,
        plugins: 'preview spellchecker code searchreplace autolink directionality table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists wordcount imagetools textpattern',
    ...
    function saveBroadcast() {
        ...
        if ($('#addForm').valid()) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('common.saveRecurringBroadcast')}}",
                data: formData,
                ...
                error: function(err) {
                    ...
                    if (err.status === 422) {
                        ...
                        _toast.error('Recurring broadcast not created.');
                    }
                },
            });
        }
