    ...
    <div class="page-title-row d-sm-flex align-items-center justify-content-between">
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Age Range</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
        ...
        @if($userType == 'admin')
            <div class="right-side mt-2 mt-md-0">
                <a href="{{route('user.addAgeRangeForm',['user_type'=>$userType])}}" class="btn btn-secondary ripple-effect-dark text-white">
                    Add
                </a>
            </div>
        @endif
        ...
        <div class="mCustomScrollbar" data-mcs-axis='x'>
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>S.No.</th>
                        <th><span class="sorting" sort-by="min_age_range">Minimum Age</span></th>
                        <th><span class="sorting" sort-by="max_age_range">Maximum Age</span></th>
...
<script>
    ...
    function loadList(url) {
        ...
        url = url || "{{route('common.loadAgeRangeList')}}";
    ...
    function changeStatus(id, status) {
        ...
        bootbox.confirm('Are you sure you want to ' + statusType + ' this age range ?', function(result) {
            if (result) {
                var url = "{{route('common.changeAgeRangeStatus', ['id'=>'%recordId%'])}}";
