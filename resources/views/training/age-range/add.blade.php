...
<div class="content-wrapper">
    ...
    <section class="content white-bg">
        <form id="addForm" class="form-head" method="POST" novalidate autocomplete="false" action="{{route('common.addAgeRange')}}">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="select-arrow">
                                    <select class="form-control" name="min_age_range">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="select-arrow">
                                    <select class="form-control" name="max_age_range">
            ...
            <div class="btn_row text-center">
                <button type="button" class="btn btn-secondary ripple-effect-dark btn-120" id="addBtn" onClick="addAgeRange()">Add<span id="addBtnLoader" class="spinner-border spinner-border-sm" style="display: none;"></span></button>
...
@section('js')
{!! JsValidator::formRequest('App\Http\Requests\AgeRangeRequest','#addForm') !!}
            ...
            $.ajax({
                ...
                error: function(err) {
                    ...
                    if (err.status === 422) {
                        ...
                        _toast.error('Age range not created.');
                    }
                },
            });
        }
