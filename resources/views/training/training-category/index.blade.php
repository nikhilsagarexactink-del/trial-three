@extends('layouts.app')
<title>Training Video Category</title>
@section('content')
...
<div class="content-wrapper">
    <div class="page-title-row d-sm-flex align-items-center justify-content-between">
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Training Category</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
        ...
        <div class="right-side mt-2 mt-md-0">
            <a href="{{route('user.addTrainingVideoCategotyForm',['user_type'=>$userType])}}" class="btn btn-secondary ripple-effect-dark text-white">
                Add
            </a>
        </div>
        @endif
...
<script>
    ...
    function loadList(url) {
        ...
        url = url || "{{route('common.loadTrainingVideoCategoryList')}}";
    ...
    function changeStatus(id, status) {
        ...
        bootbox.confirm('Are you sure you want to ' + statusType + ' this category ?', function(result) {
            if (result) {
                var url = "{{route('common.changeTrainingVideoCategoryStatus', ['id'=>'%recordId%'])}}";
