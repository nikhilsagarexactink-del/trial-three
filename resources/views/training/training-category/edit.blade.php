@extends('layouts.app')
@section('head')
<title>Trainng Video Category | Update</title>
@endsection
...
<div class="content-wrapper">
    ...
    <div class="page-title-row d-sm-flex align-items-center justify-content-between mb-3">
        <div class="left-side">
            ...
            <h2 class="page-title text-capitalize mb-0">
                Update Training Video Category
            </h2>
            <!-- Page Title End -->
        </div>
    </div>
    ...
    <section class="content white-bg">
        <form id="updateForm" class="form-head" method="PUT" novalidate autocomplete="false" action="{{route('common.updateCategory',['id'=>$id])}}">
            @csrf
            <div class="row">
                <div class="col-md-12">
...
@section('js')
{!! JsValidator::formRequest('App\Http\Requests\TrainingVideoCategoryRequest','#updateForm') !!}
