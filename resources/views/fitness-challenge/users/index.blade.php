        ...
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('user.fitnessChallenge', ['user_type' => $userType]) }}"> Fitness
                            Challenges</a></li>
                    <li class="breadcrumb-item active">Challenge Participants</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
            <h2 class="page-title text-capitalize mb-0">
                <span class="text-shadow">{{ $challenge->title }}</span> - Challenge Participants 
            </h2>
        ...
        <div class="flex-row justify-content-between align-items-end">
            <div class="left">
                ...
                <form action="javascript:void(0)" id="searchFilterForm">
                    <input type="hidden" name="sort_by" id="sortByFieldId" value="fitness_challenge_signups.created_at">
...
<script>
var orderBy = {
    field: 'fitness_challenge_signups.created_at',
    order: 'DESC',
};
...
function loadUsers(url) {
    ...
    url = url || "{{route('common.loadChallengeUsersList' ,['id' => $id ])}}";
