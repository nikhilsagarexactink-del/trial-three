@extends('layouts.app')
@section('head')
<title>Motivation Section  | Update</title>
@endsection
        ...
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Update Motivation Section</li>
                </ol>
            </nav>
            <!-- Breadcrumb End -->
            <!-- Page Title Start -->
...
<!-- {!! JsValidator::formRequest('App\Http\Requests\MotivationSectionReqeust','#updateForm') !!} -->
...
<script>
    ...
    function updateVideo() {
        ...
        if ($('#updateForm').valid()) {
            ...
            var url = "{{route('common.motivation.update', ['id'=>'%recordId%'])}}";
