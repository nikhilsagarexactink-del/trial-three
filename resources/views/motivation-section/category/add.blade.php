        ...
        <div class="left-side">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('user.indexMotivationSection', ['user_type'=>$userType])}}">Motivation Categories</a></li>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        $('#addForm')[0].reset();
                        setTimeout(function() {
                            window.location.href = "{{route('user.indexMotivationSection', ['user_type'=>$userType])}}";
                        }, 500)
                    } else {
