        ...
        <div class="page-title-row d-sm-flex align-items-center justify-content-between">
            <div class="left-side">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Motivation Categories</li>
                    </ol>
                </nav>
                <!-- Breadcrumb End -->
                <!-- Page Title Start -->
            ...
            @if ($userType == 'admin')
                <div class="right-side mt-2 mt-md-0">
                    <a href="{{ route('user.addMotivationSectionCategoryForm', ['user_type' => $userType]) }}"
            ...
            <div class="flex-row justify-content-between align-items-end">
                <div class="left">
                    ...
                    <form action="javascript:void(0)" id="searchFilterForm">
                        ...
                        <input type="hidden" name="type" value="motivation-section">
...
@section('js')
    <script>
        ...
        function loadList(url) {
            ...
            url = url || "{{ route('common.loadMotivationSectionCategoryList') }}";
