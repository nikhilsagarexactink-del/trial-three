    ...
    <div class="content-wrapper">
            ...
            <div class="left-side">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('user.indexMotivationSection', ['user_type' => $userType]) }}">Motivation Categories</a>
                        </li>
        ...
        <section class="content white-bg">
            <form id="updateForm" class="form-head" method="POST" novalidate autocomplete="false"
                action="{{ route('common.updateCategory', ['id' => $id]) }}">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="btn_row text-center">
                    <button type="button" class="btn btn-secondary ripple-effect-dark btn-120" id="updateBtn"
                        onClick="updateCategory()">Update<span id="updateBtnLoader" class="spinner-border spinner-border-sm"
                            style="display: none;"></span></button>
                    <a class="btn btn-outline-dark ripple-effect-dark btn-120 ml-2"
                        href="{{ route('user.indexGettingStarted', ['user_type' => $userType]) }}">Cancel</a>
                </div>
            </form>
        </section>
    </div>
                        ...
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                window.location.href =
                                    "{{ route('user.indexMotivationSection', ['user_type' => $userType]) }}";
                            }, 500)
                        } else {
