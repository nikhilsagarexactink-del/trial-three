            ...
            <div class="card">
                ...
                <div class="card-body ">
                    <h5 class="card-title" data-toggle="tooltip" data-placement="top"
                        title="{{ ucfirst($product->title) }}">{{ ucfirst($product->title) }} </h5>
                    ...
                    <div class="product-card-cta">
                        <button type="button" class="btn btn-primary btn-outline"
                            onClick="removeCart('{{ $product->id }}')">Remove</button>
...
@else
    ...
    <a href="{{route('user.useYourRewardIndex',['user_type'=>userType()])}}">No Items left in your cart. Add some now.</a>
    </div>
@endif
